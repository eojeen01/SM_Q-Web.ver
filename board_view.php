	    ...
	    <ul class="buttons">
			<?php
				...
				{	
					...
					<img src="./img/list.png" onclick="location.href='board_list.php?page=<?=$page?>'">&nbsp;
					...
					?>
					<img src="./img/list.png" onclick="location.href='board_list.php?page=<?=$page?>'">&nbsp;
					<img src="./img/edit1.png" onclick="location.href='board_modify_form.php?num=<?=$num?>&page=<?=$page?>'">
